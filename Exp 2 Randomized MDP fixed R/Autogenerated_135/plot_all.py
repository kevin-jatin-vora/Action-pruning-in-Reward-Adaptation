...
subplots_files =[]
for n in [1,3,5]:
    subplots_files.append([f'ours_0_{n}.csv',f'QL_0_{n}.csv',f'sfql_0_{n}.csv', f'clipped-QL_0_{n}.csv'])
...
for i, ax in enumerate(axs):
    ...
    ax.set_title("SBF " +subplots_files[i][0].split('_')[-1].replace('.csv',''))
...
plt.tight_layout()
# plt.savefig('Non_linear.png', bbox_inches='tight', dpi=600)
