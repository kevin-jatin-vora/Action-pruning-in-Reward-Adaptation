...
class GridWorld:
    def __init__(self, grid_size=(7, 7)):
        ...
        self.max_bf = 2  # Max branching factor (number of alternative actions)
        ...
        self.R1 = np.full((grid_size[0] * grid_size[1], len(self.actions), grid_size[0] * grid_size[1]), -1.5)  # Default R1 values
        self.R2 = np.full((grid_size[0] * grid_size[1], len(self.actions), grid_size[0] * grid_size[1]), -1.5)  # Default R2 values
    ...
    def set_rewards(self):
        ...
        self.R1[self.to_1d((4, 1)), self.actions.index('right'), self.to_1d((4, 2))] = 1
        ...
        self.R2[self.to_1d((5, 2)), self.actions.index('up'), self.to_1d((4, 2))] = 1
