...
# # Load the .npy files
# qm_sqfl = np.load(r"C:\Users\kevin\OneDrive\Desktop\TMLR 2025\Exp 1 Fixed MDP FIxed R\highway-city-world\memorized rewardstest_combined.npy")
# sqfl = np.load("SFQL_og.npy")
# ql = np.load("QL_traditonal.npy")
# qm = np.load(r"C:\Users\kevin\OneDrive\Desktop\TMLR 2025\Exp 1 Fixed MDP FIxed R\highway-city-world\memorized rewardsQM+SFQL\QM+SFQL_ours_MR_learning.npy")
# sqb = np.load("sqb.npy")
...
# num_cols = 1
# num_rows = 1
# fig, axs = plt.subplots(math.ceil(num_rows / num_cols), num_cols, figsize=(10, 7))
...
#         plt.Line2D([0], [0], linestyle='-', color=color_map['sqb'], label='SQB')
#     ],
#     labels=['Q-M+SFQL','Q-M', 'SFQL', 'QL','SQB'],
#     loc='upper center',
...
# plt.tight_layout()
# plt.savefig('HC_memoriezdR_learning_new.png', bbox_inches='tight', dpi=600)
# plt.show()
