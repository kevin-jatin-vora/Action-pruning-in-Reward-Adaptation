...
# Load the .npy files
qm_sqfl = np.load(r"C:\Users\kevin\Downloads\highway-city-world\memorized rewards\test_combined.npy")
sqfl = np.load("SFQL_og.npy")
ql = np.load("QL_traditonal.npy")
qm = np.load(r"C:\Users\kevin\Downloads\highway-city-world\memorized rewards\QM+SFQL\QM+SFQL_ours_MR_learning.npy")
sqb = np.load("sqb.npy")
