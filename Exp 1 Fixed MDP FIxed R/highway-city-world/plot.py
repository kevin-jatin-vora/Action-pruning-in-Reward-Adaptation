...
# Load the .npy files
qm_sqfl = np.load("QM+SFQL_ours.npy")
...
subplot_params = [
    {
        "w3": 1000,  # window size for smoothing
        "length": 3000  # ensuring the same length for all data
    }
]
