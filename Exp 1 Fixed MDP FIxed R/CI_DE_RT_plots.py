...
plt.figlegend(handles, labels, loc='upper center', bbox_to_anchor=(0.5, 1.0), ncol=3, labelspacing=0.1, fontsize=16)

# Apply tight layout to avoid overlapping labels
plt.tight_layout(rect=[0, 0, 1, 0.95])
plt.savefig('CI_exp1.jpeg', bbox_inches='tight', dpi=600)
# Show the plot
plt.show()
