...
num_rows = 1
fig, axs = plt.subplots(math.ceil(num_rows / num_cols), num_cols, figsize=(25, 5))
...
for i, ax in enumerate(axs):
    ...
    ax.set_title("Max SBF =" +str(title[i]))
...
fig.text(0.5, 0.009, 'Step', ha='center', va='center')
fig.text(0.005, 0.5, 'Average Reward', ha='center', va='center', rotation='vertical')
plt.rcParams['font.size'] = '10'

plt.tight_layout()
plt.savefig('RT.png', bbox_inches='tight', dpi=600)
