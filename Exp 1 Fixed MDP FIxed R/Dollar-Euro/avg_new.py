...
ours_0_2 = [f'{i}//ours_0_2_new.csv' for i in range(avg)]
# ours_0_3 = [f'{i}//ours_0_3_new.csv' for i in range(avg)]
ours_0_4 = [f'{i}//ours_0_4_new.csv' for i in range(avg)]
...
ours_0_2_avg.to_csv('ours_0_2_new.csv', index=False)
# ours_0_3_avg.to_csv('ours_0_3.csv', index=False)
ours_0_4_avg.to_csv('ours_0_4_new.csv', index=False)