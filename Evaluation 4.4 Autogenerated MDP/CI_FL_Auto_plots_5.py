...
# subplot_files = [
#     [['ours_0_1.csv', 'ours_0_1_new.csv', 'QL_0_1.csv', 'SFQL_0_1.csv', 'clipped-QL_0_1.csv'],
#      ['ours_0_3.csv', 'ours_0_3_new.csv', 'QL_0_3.csv', 'SFQL_0_3.csv', 'clipped-QL_0_3.csv'],
#      ['ours_0_5.csv', 'ours_0_5_new.csv', 'QL_0_5.csv', 'SFQL_0_5.csv', 'clipped-QL_0_5.csv']],
...
# List of files for each subplot in a 3x3 grid
subplot_files = [
    [['ours_0_1_new.csv', 'ours_0_1.csv', 'QL_0_1.csv', 'SFQL_0_1.csv', 'clipped-QL_0_1.csv'],
     ['ours_0_3_new.csv', 'ours_0_3.csv', 'QL_0_3.csv', 'SFQL_0_3.csv', 'clipped-QL_0_3.csv'],
     ['ours_0_5_new.csv', 'ours_0_5.csv', 'QL_0_5.csv', 'SFQL_0_5.csv', 'clipped-QL_0_5.csv']],
