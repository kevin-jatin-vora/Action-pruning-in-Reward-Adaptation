...
base_dirs = [
    'Autogenerated',  # Path to first folder
    'Frozen-Lake'   # Path to third folder
]
...
subplot_files = [
    [['ours_0_1.csv', 'QL_0_1.csv', 'SFQL_0_1.csv'],
     ...
     ['ours_0_9.csv', 'QL_0_9.csv', 'SFQL_0_9.csv']],
    
    [['ours_0_1.csv', 'QL_0_1.csv', 'SFQL_0_1.csv'],
     ['ours_0_2.csv', 'QL_0_2.csv', 'SFQL_0_2.csv'],
     ['ours_0_4.csv', 'QL_0_4.csv', 'SFQL_0_4.csv']],
]

# Define subplot parameters for each domain and method (3 domains, each with 3 different sets of params)
subplot_params = [
    [ {"w3": 150, "length": 1500}, {"w3": 150, "length": 1500}, {"w3": 150, "length": 1500} ],  # Domain 1
    [ {"w3": 150, "length": 1950}, {"w3": 150, "length": 1950}, {"w3": 150, "length": 1950} ]  # Domain 3
]
