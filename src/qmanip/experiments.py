...
EXPERIMENTS: tuple[ExperimentConfig, ...] = (
    ExperimentConfig(
        ...
        workdir=r"Evaluation 4.3 Gridworld Linear Combination - M-Q-M\Dollar-Euro",
        collect_steps=(
            ...
            LegacyCommand(
                ...
                script_name="QM.py",
                stdin_template="{start}\n{end}\n",
                workdir=r"Evaluation 4.3 Gridworld Linear Combination - Q-M\Dollar-Euro",
            ),
        ),
        aggregate_specs=(
            *_specs(
                ...
                source_workdir=r"Evaluation 4.3 Gridworld Linear Combination - M-Q-M\Dollar-Euro",
            ...
            *_specs(
                ...
                source_workdir=r"Evaluation 4.3 Gridworld Linear Combination - Q-M\Dollar-Euro",
                output_workdir=_results_dir("dollar-euro"),
            ),
        ),
    ...
    ExperimentConfig(
        ...
        workdir=r"Evaluation 4.3 Gridworld Linear Combination - M-Q-M\Racetrack",
        collect_steps=(
            LegacyCommand(
                name="QL baseline",
                script_name="QL.py",
            ...
            LegacyCommand(
                ...
                script_name="QM.py",
                stdin_template="{start}\n{end}\n",
                workdir=r"Evaluation 4.3 Gridworld Linear Combination - Q-M\Racetrack",
            ),
        ),
        aggregate_specs=(
            *_specs(
                ...
                source_workdir=r"Evaluation 4.3 Gridworld Linear Combination - M-Q-M\Racetrack",
            ...
            *_specs(
                ...
                source_workdir=r"Evaluation 4.3 Gridworld Linear Combination - Q-M\Racetrack",
                output_workdir=_results_dir("racetrack"),
            ),
        ),
        plot_script="plot_results.py",
    ...
    ExperimentConfig(
        ...
        workdir=r"Evaluation 4.3 Gridworld Linear Combination - M-Q-M\Frozen-Lake",
        collect_steps=(
            LegacyCommand(
                name="QL baseline",
                script_name="QL.py",
            ...
            LegacyCommand(
                ...
                script_name="QM.py",
                stdin_template="{start}\n{end}\n",
                workdir=r"Evaluation 4.3 Gridworld Linear Combination - Q-M\Frozen-Lake",
            ),
        ),
        aggregate_specs=(
            *_specs(
                ...
                source_workdir=r"Evaluation 4.3 Gridworld Linear Combination - M-Q-M\Frozen-Lake",
            ...
            *_specs(
                ...
                source_workdir=r"Evaluation 4.3 Gridworld Linear Combination - Q-M\Frozen-Lake",
                output_workdir=_results_dir("frozen-lake"),
            ),
        ),
        plot_script="plot_results.py",
    ...
    ExperimentConfig(
        ...
        workdir=r"Evaluation 4.4 Autogenerated MDP\Linear-Combination",
        collect_steps=(
            LegacyCommand(
        ...
        aggregate_specs=(
            *_specs(
                ...
                source_workdir=r"Evaluation 4.4 Autogenerated MDP\Linear-Combination",
    ...
    ExperimentConfig(
        ...
        workdir=r"Evaluation 4.4 Autogenerated MDP\Nonlinear-Combination",
        collect_steps=(
            LegacyCommand(
                name="Generate per-seed MDPs",
                script_name="generate_mdp.py",
        ...
        aggregate_specs=(
            *_specs(
                ...
                source_workdir=r"Evaluation 4.4 Autogenerated MDP\Nonlinear-Combination",
    ...
    ExperimentConfig(
        ...
        workdir=r"Evaluation 4.5 Noisy Combination\Noisy-Combination",
        collect_steps=(
            LegacyCommand(
                name="Generate per-seed MDPs",
                script_name="generate_mdp.py",
        ...
        aggregate_specs=(
            *_specs(
                ...
                source_workdir=r"Evaluation 4.5 Noisy Combination\Noisy-Combination",
