...
for avg in range(st,ed):
    ...
    for noise in [0.003, 0.006,0.009, 0.012,0.015]:
        ...
        file_path = f"{avg}/r_target_{noise}_{bf}.npy"
        ...
        # break
pd.DataFrame(data, columns=['Run', 'Domain', '|S|', '|A|', 'Actions Pruned']).to_csv(f"Data_RA_{ed-1}_new.csv")
