...
noise_levels = [0.003, 0.006,0.009, 0.012,0.015] #[0, 0.015, 0.02, 0.025, 0.03]

# Create lists of CSV file paths dynamically for each noise level
ours_files = {
    f'ours_0_{noise}_new': [f'{i}//ours_0_{noise}_new.csv' for i in range(avg)] 
