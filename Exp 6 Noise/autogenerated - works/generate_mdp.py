...
num_actions = 9 #random.randint(9, 20)
num_states = 60 #random.randint(num_actions, 80)
print(num_actions)
print(num_states)
...
for i in range(num_states):
    ...
    for j in range(num_actions):
        ...
        action_probs[high_prob_state] = 0.9  # Assign 0.7 probability to the selected high-prob state
...
terminal_state = [20,35,42]#list(np.random.randint(low=1,high=num_states, size=3))
...
rewards2[x[0],y[0],terminal_state[0]] = -1.1

# State 2: r1 = -1, r2 = +1, r3 = 0
rewards[x[1],y[1],terminal_state[1]] = -1.1
